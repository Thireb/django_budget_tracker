...
from budgetapp.models import Budget, Expense, SubExpense, BudgetLog, ArchivedBudget
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS('Successfully restored data from backup')
            )
            ...
            self.stdout.write(
                self.style.ERROR(f'Invalid JSON in backup file: {backup_file}')
            )
